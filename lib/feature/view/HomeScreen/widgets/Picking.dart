                      ...
                      onTap: ()
                      {
                        Navigator.push(
                          ...
                          MaterialPageRoute(builder:
                              (context) => const PickHeaderNotStarted()),
                        );
                      },
                      child: Container(
                        height: 60,
                    ...
                    GestureDetector(
                      onTap: ()
                      {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder:
                              (context) => const PickHeaderOngoing()),
                        );
                      },
                      child: Container(
                        height: 60,
                    ...
                    GestureDetector(
                      onTap: ()
                      {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder:
                              (context) => const PickHeaderCompleted()),
                        );
                      },
                      child: Container(
                        height: 60,
