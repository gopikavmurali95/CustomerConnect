...
/* 
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<CustomerSettingsBloc, CustomerSettingsState>(
                            ...
                            child: Column(
                              children: [
                                ...
                                Visibility(
                                  ...
                                  child: BlocBuilder<InverntoryTransExPandCubit,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  gradient: LinearGradient(
                                    colors: [
                                      const Color(0xfffcfcfc).withOpacity(.0),
              ...
              Positioned(
                ...
                child: BlocBuilder<HomeAppBarCubit, HomeAppBarState>(
                  builder: (context, state) {
                    return AppBar(
                      backgroundColor:
                          state.isScrolled ? Colors.white : Colors.transparent,
                      titleSpacing: 1,
                      elevation: 0,
