...
class MaterialRequestHeaderScreen extends StatefulWidget {
  ...
  @override
  State<MaterialRequestHeaderScreen> createState() => _MaterialRequestHeaderScreenState();
}

class _MaterialRequestHeaderScreenState extends State<MaterialRequestHeaderScreen> {
  @override
  void initState() {
    context
        ...
        children: [
          Expanded(
              child: Padding(
                ...
                child: BlocBuilder<MaterialReqHeadBloc,
                    MaterialReqHeadState>(
