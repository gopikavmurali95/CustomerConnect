...
class _MaterialRequestDetailScreenState
  ...
  void initState() {
    ...
    context.read<MaterialReqDetailBloc>().add(
          const MaterialReqDetailSuccessEvent(reqId: '1'),
        );
          ...
          listener: (context, state) {
            state.when(
                materialreqdetailsuccess: (details) {
                  if (details != null) {
                    statuslist = List.generate(details.length, (index) => null);
                  }
                },
                                                        ...
                                                        onPressed: () {
                                                          context
                                                              .read<
                                                                  MaterialReqDetailBloc>()
                                                              .add(
                                                                  const MaterialReqDetailSuccessEvent(
                                                                      reqId:
                                                                          ''));
                                                          Navigator.pop(
                                                              context);
                                                                    ...
                                                                    context
                                                                        ...
                                                                        .add(
                                                                          MaterialReqApprovalSuccessEvent(
                                                                            ...
                                                                            warehouse:
                                                                                widget.materialrequest.warName,
                                                                          )),
                                                                        );
