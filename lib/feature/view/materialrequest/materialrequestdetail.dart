...
class _MaterialRequestDetailScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PopScope(
        ...
        child: BlocListener<MaterialReqDetailBloc, MaterialReqDetailState>(
    ...
    // TODO: implement listener}
          ...
          onRefresh: () => _onRefreshMaterialReqDetailScreen(context, widget.user),//_onRefreshMaterialReqHeaderScreen(context,widget.user),
    child: SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
                children: [
                  ...
                  BlocBuilder<MaterialReqDetailBloc, MaterialReqDetailState>(
                          ...
                          child: Column(
                            children: [
                              Row(
                               ...
                               Row(
                                children: [
                                  BlocConsumer<MaterialReqApprovalBloc,
                                                      ...
                                                      TextButton(
                                                        onPressed: () {
                                                          context
                                                              ...
                                                              .add(
                                                              const MaterialReqDetailSuccessEvent(reqId: ''
                                                                  ));
                                                          Navigator.pop(context);
                                                        },
                                                        child:
                                                                  ...
                                                                  context
                                                                    ...
                                                                    MaterialReqApprovalSuccessEvent(
                                                                        ...
                                                                        approvalInModel: MaterialReqApprovalInModel(
                                                                          ...
                                                                          // hqty: widget,
                                                                          // lqty: details[index].requestedLQty,
                                                                          // userId:  ,
                                                                          // reqID: ,
                                                                          // mode: widget.materialrequest. ,
  ...
  Future<void> _onRefreshMaterialReqDetailScreen(BuildContext context,LoginUserModel model) async
  {
