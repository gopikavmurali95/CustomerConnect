...
class MerchandiseCreditNoteRequestScreen extends StatefulWidget {
  ...
  const MerchandiseCreditNoteRequestScreen({super.key,});

  @override
  State<MerchandiseCreditNoteRequestScreen> createState() => _CreditNoteHeaderScreenState();
}
...
class _CreditNoteHeaderScreenState extends State<MerchandiseCreditNoteRequestScreen> {
  @override
