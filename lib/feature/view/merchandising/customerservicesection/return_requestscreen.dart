...
class MerchandiseReturnRequestScreen extends StatefulWidget {
  ...
  const MerchandiseReturnRequestScreen({super.key,});

  @override
  State<MerchandiseReturnRequestScreen> createState() => _CreditNoteHeaderScreenState();
}
...
class _CreditNoteHeaderScreenState extends State<MerchandiseReturnRequestScreen> {
  @override
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                                           "SKY FALCON CAFTERIA & RESTUARANT",
                                                            style: kfontstyle(
                                                                fontSize:
                                                                    12.sp,
                                                                color: const Color(
