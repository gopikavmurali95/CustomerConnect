...
class FieldServiceInvoiceHeader extends StatelessWidget {
  ...
  final TextEditingController _fieldServiceSearchController = TextEditingController();
                      ...
                      debounce = Timer(
                        ...
                        context.read<FieldServiceHeaderBloc>().add(
                            GetAllFieldServiceHeadersEvent(
                                ...
                                searchQuery: _fieldServiceSearchController.text, userId: ''));
                      });
                                ...
                                onPressed: () {
                                  if (_fieldServiceSearchController
                                    ...
                                    context
                                        ...
                                        .add(const GetAllFieldServiceHeadersEvent(
