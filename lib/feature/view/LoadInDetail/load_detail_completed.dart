...
class LoadDetailCompleted extends StatelessWidget {
  const LoadDetailCompleted({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Load In Detail",style: appHeading(),
        ),
              ...
              ListTile(
                  ...
                  trailing: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:  Color(0xffBDF1B7)
                      ),
                      child: const Center(child: Text("Completed",style: TextStyle(fontSize:10),)))
              ),
              Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("LI Qty",style: boxHeading(),),
                  ),
                ],
              ),
            ),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Text("2",style: subTitleTextStyle(),),
                              SizedBox(height: 5,),
