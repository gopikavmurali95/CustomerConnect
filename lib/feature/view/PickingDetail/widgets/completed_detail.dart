  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PickingdetailBloc, PickingdetailState>(
      builder: (context, state) {
        return state.when(
            pickingSuccessState: (pdetailList) => pdetailList==null? const CupertinoActivityIndicator(
              animating: true,
              color: Colors.red,
              radius: 30,
            ):ListView.separated(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("${pdetailList[index].prdCode}", style: loadTextStyle()),
                                Text(
                        ...
                        Column(
                          ...
                          children: [
                            Visibility(
                              visible: pdetailList[index].pkdHigherUom==null||
                                  pdetailList[index].pkdHigherUom!.isEmpty ? false:true,
                              child: Text(
