...
import 'package:customer_connect/feature/view/settlementapprovaldesigns/settlementapprovaldetailscreen.dart';
import 'package:customer_connect/feature/widgets/shimmer.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class SettlementApprovalHeader extends StatefulWidget {
  final LoginUserModel user;
  const SettlementApprovalHeader({super.key, required this.user});

  @override
  State<SettlementApprovalHeader> createState() => _PriceChangeHeaderState();
}
...
class _PriceChangeHeaderState extends State<SettlementApprovalHeader> {
  @override
  void initState() {
