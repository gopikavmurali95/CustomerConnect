                ...
                return Column(
                  children: [
                    SizedBox(
                      ...
                      child: ListTile(
                        onTap: () {
                          context.read<PickingdetailBloc>().add(ClearPickingDetailevent());
                          context.read<PickingdetailBloc>().add(PickingDetailSuccess(
                              PickingID: pickingOut[index].pickingID!));
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>PickingOgoing(picking:pickingOut[index],),
                            ),
                          );
                        },
                              ...
                              text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        ...
                                        style: subTitleTextStyle()),
                                    TextSpan(
                                        text: "${pickingOut[index].time}", style: subTitleTextStyle())
                                  ])),
                        ),
                      ),
                    ),
