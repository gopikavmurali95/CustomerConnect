...
@injectable
class CusInsightCustomersPaginationCubit
    extends Cubit<CusInsightCustomersPaginationState> {
  final ICusInsightsCustomersRepo cusInsightsCustomersRepo;
  CusInsightCustomersPaginationCubit(this.cusInsightsCustomersRepo)
      : super(CusInsightCustomersPaginationState.initial());

  void getCustomersHeader(
    ...
    Either<MainFailures, List<CusInsCustomersModel>> header =
    ...
    emit(header.fold((l) => state.copyWith(headers: oldcustomerlist), (r) {
      ...
      return GetCustomersHeaderPageState(
          headers: oldcustomerlist, isLoading: false);
    }));
  }
