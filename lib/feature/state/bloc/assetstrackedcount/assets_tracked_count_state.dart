...
class AssetsTrackedCountState with _$AssetsTrackedCountState {
  ...
  const factory AssetsTrackedCountState.assetsTrackedCountFailedState() = AssetsTrackedCountFailedState;
  
  
 factory AssetsTrackedCountState.initial() => 
 const AssetsTrackedCountState.assetsTrackedCountSuccessState(assetsTracked: null);
