...
class LoadReqApprovalState with _$LoadReqApprovalState {
  const factory LoadReqApprovalState.loadReqApprovalSuccessState(
      {required LoadRequestApprovalOutModel? response}) = LoadReqApprovalSuccessState;
  const factory LoadReqApprovalState.loadReqApprovalFailedState() = LoadReqApprovalFailedState;
  const factory LoadReqApprovalState.loadReqApprovalLoadingState() =LoadReqApprovalLoadingState;
