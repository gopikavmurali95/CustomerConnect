...
class LoadReqHeaderState with _$LoadReqHeaderState {
  ...
  const factory LoadReqHeaderState.loadReqheadFailedState() = LoadReqheadFailedState;
  factory LoadReqHeaderState.initial() => const  LoadReqHeaderState.loadReqheadSuccessState(loadlist: null);
