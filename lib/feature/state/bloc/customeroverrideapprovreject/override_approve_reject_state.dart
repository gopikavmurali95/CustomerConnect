...
class OverrideApproveRejectState with _$OverrideApproveRejectState {
  ...
  ({required OverideApprovRejectModel? approve}) =
   GetOverrideApprovalState;

  const factory OverrideApproveRejectState.overrideCusFailedState() = OverrideCusFailedState;

  const factory OverrideApproveRejectState.overrideCusLoadingState() = OverrideCusLoadingState;
