...
import 'package:customer_connect/feature/domain/chat/getallusersrepo.dart'
    as _i10;
import 'package:customer_connect/feature/domain/chat/messagesrepo.dart' as _i43;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.IMerchReturnReqRepo>(
        () => _i39.MerchReturnRequestRepo());
    gh.lazySingleton<_i3.IMerchandinsingSurveyRepo>(
        () => _i40.MerchandisingSurveyRepo());
    gh.lazySingleton<_i3.IMerchandiseTaskHeaderRepo>(
        () => _i41.MerchandiseTaskRepo());
    gh.lazySingleton<_i3.IMerchandisingDashBoardRepo>(
        () => _i42.MerchandisingScreenRepo());
    gh.lazySingleton<_i9.IMessageRepo>(() => _i43.MessagesRepo());
    gh.lazySingleton<_i3.IMustSellRepo>(() => _i44.MustSellRepo());
    gh.lazySingleton<_i3.INotificationRepo>(() => _i45.NotificationRepo());
    gh.lazySingleton<_i3.IOutOfStockProductsRepo>(
        () => _i46.OutOfStockItemsRepo());
    gh.lazySingleton<_i3.IOutStandingHeaderRepo>(
        () => _i47.OutStandingHeadRepo());
    gh.lazySingleton<_i3.IPartialDeliveryRepo>(
        () => _i48.PartialDeliveryRepo());
    gh.lazySingleton<_i3.IPickingAndLoadinCountRepo>(
        () => _i49.PickingAndLoadinCountRepo());
    gh.lazySingleton<_i3.IPickingHeaderRepo>(() => _i50.PickingHeaderRepo());
    gh.lazySingleton<_i3.IPriceChangeRepo>(() => _i51.PriceChangeRepo());
    gh.lazySingleton<_i3.IProfileEditRepo>(() => _i52.ProfileEditingRepo());
    gh.lazySingleton<_i3.IPromotionHeaderRepo>(
        () => _i53.PromotionHeaderRepo());
    gh.lazySingleton<_i3.IQualificationGroupRepo>(
        () => _i54.QualificationGroupREpo());
    gh.lazySingleton<_i3.IReturnApprovalRepo>(() => _i55.ReturnApprovalRepo());
    gh.lazySingleton<_i3.ISalesOrderRepo>(() => _i56.SalesOrderCountRepo());
    gh.lazySingleton<_i3.ISalesOrdersRepo>(() => _i57.SalesOrdersRepo());
    gh.lazySingleton<_i3.IScheduledReturnApprovalRepo>(
        () => _i58.ScheduledReturnApprovalRepo());
    gh.lazySingleton<_i3.ISettlementApprovalHeaderRepo>(
        () => _i59.SettlementApproval());
    gh.lazySingleton<_i3.ISpecialPriceRepo>(() => _i60.SpecialPriceRepo());
    gh.lazySingleton<_i3.ITargetRepo>(() => _i61.TargetHeaderCountRepo());
    gh.lazySingleton<_i3.ITodaysDeliveryRepo>(() => _i62.TodaysDelivery());
    gh.lazySingleton<_i3.ITotalOrdersRepo>(() => _i63.TotalOrderRepo());
    gh.lazySingleton<_i3.ITrackSalesManRepo>(() => _i64.TrackSalesManRepo());
    gh.lazySingleton<_i3.IVanToVanApprovalRepo>(
        () => _i65.VanToVanApprovalRepo());
    gh.lazySingleton<_i3.IVoidTransactionRepo>(
        () => _i66.VoidTransactionHeaderRepo());
    gh.lazySingleton<_i3.IcusDocumentsModel>(() => _i67.CusDocumentsRepo());
    gh.lazySingleton<_i3.IcusInsCountsRepo>(() => _i68.CusTrnCOuntsRepo());
    gh.lazySingleton<_i3.IinvetoryReconfirmationApprovalRepo>(
        () => _i69.InventoryReconfirmationRepo());
    gh.factory<_i70.InventoryReconfirmApprovalBloc>(() =>
        _i70.InventoryReconfirmApprovalBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i71.InventoryReconfirmDetailBloc>(() =>
        _i71.InventoryReconfirmDetailBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i72.InventoryReconfirmHeaderBloc>(() =>
        _i72.InventoryReconfirmHeaderBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i73.InventoryReconfirmReasonsCubit>(() =>
        _i73.InventoryReconfirmReasonsCubit(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i74.InvoiceDetailsBloc>(
        () => _i74.InvoiceDetailsBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i75.InvoiceDetailsFooterBloc>(
        () => _i75.InvoiceDetailsFooterBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i76.InvoiceHeaderBloc>(
        () => _i76.InvoiceHeaderBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i77.JoureyPlanApprovalBloc>(
        () => _i77.JoureyPlanApprovalBloc(gh<_i3.IJourneyPlanApprovalRepo>()));
    gh.factory<_i78.JourneyPlanHeaderBloc>(
        () => _i78.JourneyPlanHeaderBloc(gh<_i3.IJourneyPlanApprovalRepo>()));
    gh.factory<_i79.LoadReqApprovalBloc>(
        () => _i79.LoadReqApprovalBloc(gh<_i3.ILoadRequestApprovalRepo>()));
    gh.factory<_i80.LoadReqDetailBloc>(
        () => _i80.LoadReqDetailBloc(gh<_i3.ILoadRequestHeaderRepo>()));
    gh.factory<_i81.LoadReqHeaderBloc>(
        () => _i81.LoadReqHeaderBloc(gh<_i3.ILoadRequestHeaderRepo>()));
    gh.factory<_i82.LoadTransferApprovalBloc>(() =>
        _i82.LoadTransferApprovalBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    gh.factory<_i83.LoadTransferDetailBloc>(
        () => _i83.LoadTransferDetailBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    gh.factory<_i84.LoadTransferHeaderBloc>(
        () => _i84.LoadTransferHeaderBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    ...
    gh.factory<_i88.MaterialReqApprovalBloc>(
        () => _i88.MaterialReqApprovalBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i89.MaterialReqDetailBloc>(
        () => _i89.MaterialReqDetailBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i90.MaterialReqHeadBloc>(
        () => _i90.MaterialReqHeadBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i91.MaterialReqRejectionBloc>(
        () => _i91.MaterialReqRejectionBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i92.MerchCreditNoteRequestBloc>(() =>
        _i92.MerchCreditNoteRequestBloc(gh<_i3.IMerchCreditNoteReqRepo>()));
    gh.factory<_i93.MerchCusActCountBloc>(
        () => _i93.MerchCusActCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i94.MerchCustomerActivitiesBloc>(() =>
        _i94.MerchCustomerActivitiesBloc(
            gh<_i3.IMerchCustomerActivitiesRepo>()));
    gh.factory<_i95.MerchDisplayAgreementBloc>(
        () => _i95.MerchDisplayAgreementBloc(gh<_i3.IMerchDisplayAgreement>()));
    gh.factory<_i96.MerchReturnRequestBloc>(
        () => _i96.MerchReturnRequestBloc(gh<_i3.IMerchReturnReqRepo>()));
    gh.factory<_i97.MerchSurveyCountBloc>(
        () => _i97.MerchSurveyCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i98.MerchTaskCountBloc>(
        () => _i98.MerchTaskCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i99.MerchandTaskHeaderBloc>(() =>
        _i99.MerchandTaskHeaderBloc(gh<_i3.IMerchandiseTaskHeaderRepo>()));
    gh.factory<_i100.MerchandisingSurveyBloc>(() =>
        _i100.MerchandisingSurveyBloc(gh<_i3.IMerchandinsingSurveyRepo>()));
    gh.factory<_i101.MerchdisplaycountBloc>(() =>
        _i101.MerchdisplaycountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i102.MessagesBloc>(
        () => _i102.MessagesBloc(gh<_i9.IMessageRepo>()));
    gh.factory<_i103.MustSellApproveBloc>(
        () => _i103.MustSellApproveBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i104.MustSellDetailBloc>(
        () => _i104.MustSellDetailBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i105.MustSellHeaderBloc>(
        () => _i105.MustSellHeaderBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i106.NotiReadFlagUpdateBloc>(
        () => _i106.NotiReadFlagUpdateBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i107.NotificationListingBloc>(
        () => _i107.NotificationListingBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i108.NotificationReplayBlocBloc>(
        () => _i108.NotificationReplayBlocBloc(gh<_i3.INotificationRepo>()));
    ...
    gh.factory<_i111.OutofstockcountBloc>(
        () => _i111.OutofstockcountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i112.OutstandingBloc>(
        () => _i112.OutstandingBloc(gh<_i3.IOutStandingHeaderRepo>()));
    gh.factory<_i113.PartialDeliveryApprovalBloc>(() =>
        _i113.PartialDeliveryApprovalBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i114.PartialDeliveryDetailBloc>(
        () => _i114.PartialDeliveryDetailBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i115.PartialDeliveryDetailsBloc>(
        () => _i115.PartialDeliveryDetailsBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i116.PartialDeliveryHeaderBloc>(
        () => _i116.PartialDeliveryHeaderBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i117.PartialDeliveryReasonBloc>(
        () => _i117.PartialDeliveryReasonBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i118.PartialDeliveryReasonCubit>(
        () => _i118.PartialDeliveryReasonCubit(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i119.PickingAndLoadingCountBloc>(() =>
        _i119.PickingAndLoadingCountBloc(gh<_i3.IPickingAndLoadinCountRepo>()));
    gh.factory<_i120.PickingHeaderBloc>(
        () => _i120.PickingHeaderBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i121.PickingdetailBloc>(
        () => _i121.PickingdetailBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i122.PostSettlementApprovalBloc>(() =>
        _i122.PostSettlementApprovalBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i123.PriceChangeDetailsBloc>(
        () => _i123.PriceChangeDetailsBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i124.PriceChangeHeaderBloc>(
        () => _i124.PriceChangeHeaderBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i125.PriceChangeReasonsBloc>(
        () => _i125.PriceChangeReasonsBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i126.PromotionCustomerBloc>(
        () => _i126.PromotionCustomerBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i127.PromotionDetailsBloc>(
        () => _i127.PromotionDetailsBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i128.PromotionHeaderBloc>(
        () => _i128.PromotionHeaderBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i129.QualificationGroupBloc>(
        () => _i129.QualificationGroupBloc(gh<_i3.IQualificationGroupRepo>()));
    gh.factory<_i130.RargetDetailsGraphQtyBloc>(
        () => _i130.RargetDetailsGraphQtyBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i131.ReturnApprovalDetailBloc>(
        () => _i131.ReturnApprovalDetailBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i132.ReturnApprovalHeaderBloc>(
        () => _i132.ReturnApprovalHeaderBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i133.RouteForScCubit>(
        () => _i133.RouteForScCubit(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i134.SalesOrderCountBloc>(
        () => _i134.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i135.SalesOrderDetailsBloc>(
        () => _i135.SalesOrderDetailsBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i136.SchduledReturnApprovalBloc>(() =>
        _i136.SchduledReturnApprovalBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i137.SchduledReturnHeaderBloc>(() =>
        _i137.SchduledReturnHeaderBloc(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i138.ScheduledReturnDetailsBloc>(() =>
        _i138.ScheduledReturnDetailsBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i139.SettlementApprovalHeaderBloc>(() =>
        _i139.SettlementApprovalHeaderBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i140.SettlementApprovalRejectBloc>(() =>
        _i140.SettlementApprovalRejectBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i141.SettlementCashDetailsBloc>(() =>
        _i141.SettlementCashDetailsBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i142.SettlementPayModeDetailBloc>(() =>
        _i142.SettlementPayModeDetailBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i143.SettlementPaymentDetailBloc>(() =>
        _i143.SettlementPaymentDetailBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i144.SpecialPriceCustomersBloc>(
        () => _i144.SpecialPriceCustomersBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i145.SpecialPriceDetailsBloc>(
        () => _i145.SpecialPriceDetailsBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i146.SpecialPriceHeaderBloc>(
        () => _i146.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i147.TargerHeaderListBloc>(
        () => _i147.TargerHeaderListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i148.TargetDetailsCountBloc>(
        () => _i148.TargetDetailsCountBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i149.TargetDetailsGraphAmtBloc>(
        () => _i149.TargetDetailsGraphAmtBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i150.TargetDetailsListBloc>(
        () => _i150.TargetDetailsListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i151.TargetHeaderCountBloc>(
        () => _i151.TargetHeaderCountBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i152.TargetPackageListBloc>(
        () => _i152.TargetPackageListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i153.TodaysDeliveryDetailsBloc>(
        () => _i153.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i154.TodaysDeliveryHeaderBloc>(
        () => _i154.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i155.TotalOrdersDetailsBloc>(
        () => _i155.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i156.TotalOrdersHeaderBloc>(
        () => _i156.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i157.TrackSalesManListBloc>(
        () => _i157.TrackSalesManListBloc(gh<_i3.ITrackSalesManRepo>()));
    gh.factory<_i158.UpdateGeoLocationCubit>(
        () => _i158.UpdateGeoLocationCubit(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i159.UserLoginBloc>(
        () => _i159.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i160.VanToVanApprovalBloc>(
        () => _i160.VanToVanApprovalBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i161.VanToVanDetailsBloc>(
        () => _i161.VanToVanDetailsBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i162.VanToVanHeaderBloc>(
        () => _i162.VanToVanHeaderBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i163.VoidTransactionApprovalBloc>(() =>
        _i163.VoidTransactionApprovalBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i164.VoidTransactionHeaderBloc>(
        () => _i164.VoidTransactionHeaderBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i165.VoidTransactionRejectionBloc>(() =>
        _i165.VoidTransactionRejectionBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i166.ActivityReviewDetailBloc>(
        () => _i166.ActivityReviewDetailBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i167.ActivityReviewHeaderBloc>(
        () => _i167.ActivityReviewHeaderBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i168.ActivityReviewSalesDataBloc>(
        () => _i168.ActivityReviewSalesDataBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i169.ActivityReviewTargetsBloc>(
        () => _i169.ActivityReviewTargetsBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i170.AllUsersBloc>(
        () => _i170.AllUsersBloc(gh<_i9.IChatUserRepo>()));
    gh.factory<_i171.ApprovalCountsBloc>(
        () => _i171.ApprovalCountsBloc(gh<_i3.IApprovalCountsRepo>()));
    gh.factory<_i172.ApprovalReasonsBloc>(
        () => _i172.ApprovalReasonsBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i173.ApprovePriceChangeBloc>(
        () => _i173.ApprovePriceChangeBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i174.ApproveReturnProductBloc>(
        () => _i174.ApproveReturnProductBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i175.ArDetailsBloc>(
        () => _i175.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i176.ArHeaderBloc>(
        () => _i176.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i177.AssetAddInApprovalHeaderBloc>(() =>
        _i177.AssetAddInApprovalHeaderBloc(gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i178.AssetAddingApprovalAndRjectBlocBloc>(() =>
        _i178.AssetAddingApprovalAndRjectBlocBloc(
            gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i179.AssetRemovalApprvalBloc>(() =>
        _i179.AssetRemovalApprvalBloc(gh<_i3.IAssetRemovalRequestRepo>()));
    gh.factory<_i180.AssetRemovelRequestHeaderBloc>(() =>
        _i180.AssetRemovelRequestHeaderBloc(
            gh<_i3.IAssetRemovalRequestRepo>()));
    gh.factory<_i181.ChartActualVisitsBloc>(
        () => _i181.ChartActualVisitsBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i182.ChartNonProductiveBloc>(
        () => _i182.ChartNonProductiveBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i183.ChartPlannedVisitsBloc>(
        () => _i183.ChartPlannedVisitsBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i184.ChartProductiveVisitBloc>(
        () => _i184.ChartProductiveVisitBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i185.ChartRoutsBloc>(
        () => _i185.ChartRoutsBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i186.CreditNoteApprovalAndRejectBloc>(() =>
        _i186.CreditNoteApprovalAndRejectBloc(
            gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i187.CreditNoteApprovalLevelStatusCubit>(() =>
        _i187.CreditNoteApprovalLevelStatusCubit(
            gh<_i3.ICreditNoteApprovalRepo>()));
    ...
    gh.factory<_i190.CusDocumentsBloc>(
        () => _i190.CusDocumentsBloc(gh<_i3.IcusDocumentsModel>()));
    gh.factory<_i191.CusGeoLocationBloc>(
        () => _i191.CusGeoLocationBloc(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i192.CusInsArHeaderBloc>(
        () => _i192.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i193.CusInsInvoiceHeaderBloc>(
        () => _i193.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i194.CusInsTrnCountBloc>(
        () => _i194.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i195.CusInvDetailBlocBloc>(
        () => _i195.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i196.CusItemsBloc>(
        () => _i196.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i197.CusOutStandingBloc>(
        () => _i197.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i198.CusProfileBloc>(
        () => _i198.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i199.CusPromoDetailBloc>(
        () => _i199.CusPromoDetailBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i200.CusPromotionsHeaderBloc>(
        () => _i200.CusPromotionsHeaderBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i201.CusSalesOrdersBloc>(
        () => _i201.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i202.CusSpPriceBloc>(
        () => _i202.CusSpPriceBloc(gh<_i3.ICusSpPriceRepo>()));
    gh.factory<_i203.CustomerInsightGroupBloc>(
        () => _i203.CustomerInsightGroupBloc(gh<_i3.ICusInsightGroupRepo>()));
    gh.factory<_i204.CustomerSettingsBloc>(
        () => _i204.CustomerSettingsBloc(gh<_i3.ICustomerSettingsRepo>()));
    gh.factory<_i205.CustomerTransactionBloc>(() =>
        _i205.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i206.CustomersListBlocBloc>(
        () => _i206.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    gh.factory<_i207.DisputeApprovalStatusLevelCubitCubit>(() =>
        _i207.DisputeApprovalStatusLevelCubitCubit(
            gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i208.DisputeNoteApprovalAndRejectBloc>(() =>
        _i208.DisputeNoteApprovalAndRejectBloc(
            gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i209.DisputeNoteDetailBloc>(
        () => _i209.DisputeNoteDetailBloc(gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i210.DisputeNoteHeaderBloc>(
        () => _i210.DisputeNoteHeaderBloc(gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i211.EditCusProfileBloc>(
        () => _i211.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    gh.factory<_i212.FIeldServiceDetailBloc>(() => _i212.FIeldServiceDetailBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i213.FieldServiceHeaderBloc>(() => _i213.FieldServiceHeaderBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i214.FieldServiceInvoiceApprovalBloc>(() =>
        _i214.FieldServiceInvoiceApprovalBloc(
            gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
