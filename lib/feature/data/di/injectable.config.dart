...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i25.TotalOrdersDetailsBloc>(
        () => _i25.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i26.TotalOrdersHeaderBloc>(
        () => _i26.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i27.UserLoginBloc>(
        () => _i27.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i28.ArDetailsBloc>(
        () => _i28.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i29.ArHeaderBloc>(
        () => _i29.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i30.CusInsArHeaderBloc>(
        () => _i30.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i31.CusInsInvoiceHeaderBloc>(
        () => _i31.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i32.CusInsTrnCountBloc>(
        () => _i32.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i33.CusInvDetailBlocBloc>(
        () => _i33.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i34.CusProfileBloc>(
        () => _i34.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
