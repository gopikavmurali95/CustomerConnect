...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.IMerchandinsingSurveyRepo>(
        () => _i33.MerchandisingSurveyRepo());
    gh.lazySingleton<_i3.IMerchandisingDashBoardRepo>(
        () => _i34.MerchandisingScreenRepo());
    gh.lazySingleton<_i8.IMessageRepo>(() => _i35.MessagesRepo());
    ...
    gh.lazySingleton<_i3.IOutStandingHeaderRepo>(
        () => _i38.OutStandingHeadRepo());
    gh.lazySingleton<_i3.IPartialDeliveryRepo>(
        () => _i39.PartialDeliveryRepo());
    gh.lazySingleton<_i3.IPickingAndLoadinCountRepo>(
        () => _i40.PickingAndLoadinCountRepo());
    gh.lazySingleton<_i3.IPickingHeaderRepo>(() => _i41.PickingHeaderRepo());
    gh.lazySingleton<_i3.IPriceChangeRepo>(() => _i42.PriceChangeRepo());
    gh.lazySingleton<_i3.IProfileEditRepo>(() => _i43.ProfileEditingRepo());
    gh.lazySingleton<_i3.IPromotionHeaderRepo>(
        () => _i44.PromotionHeaderRepo());
    gh.lazySingleton<_i3.IQualificationGroupRepo>(
        () => _i45.QualificationGroupREpo());
    gh.lazySingleton<_i3.IReturnApprovalRepo>(() => _i46.ReturnApprovalRepo());
    gh.lazySingleton<_i3.ISalesOrderRepo>(() => _i47.SalesOrderCountRepo());
    gh.lazySingleton<_i3.ISalesOrdersRepo>(() => _i48.SalesOrdersRepo());
    gh.lazySingleton<_i3.IScheduledReturnApprovalRepo>(
        () => _i49.ScheduledReturnApprovalRepo());
    gh.lazySingleton<_i3.ISettlementApprovalHeaderRepo>(
        () => _i50.SettlementApproval());
    gh.lazySingleton<_i3.ISpecialPriceRepo>(() => _i51.SpecialPriceRepo());
    gh.lazySingleton<_i3.ITargetRepo>(() => _i52.TargetHeaderCountRepo());
    ...
    gh.factory<_i82.MerchandisingSurveyBloc>(() =>
        _i82.MerchandisingSurveyBloc(gh<_i3.IMerchandinsingSurveyRepo>()));
    gh.factory<_i83.MessagesBloc>(
        () => _i83.MessagesBloc(gh<_i8.IMessageRepo>()));
    gh.factory<_i84.MustSellApproveBloc>(
        () => _i84.MustSellApproveBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i85.MustSellDetailBloc>(
        () => _i85.MustSellDetailBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i86.MustSellHeaderBloc>(
        () => _i86.MustSellHeaderBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i87.NotiReadFlagUpdateBloc>(
        () => _i87.NotiReadFlagUpdateBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i88.NotificationListingBloc>(
        () => _i88.NotificationListingBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i89.NotificationReplayBlocBloc>(
        () => _i89.NotificationReplayBlocBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i90.OutofstockcountBloc>(
        () => _i90.OutofstockcountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    ...
    gh.factory<_i109.RargetDetailsGraphQtyBloc>(
        () => _i109.RargetDetailsGraphQtyBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i110.ReturnApprovalDetailBloc>(
        () => _i110.ReturnApprovalDetailBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i111.ReturnApprovalHeaderBloc>(
        () => _i111.ReturnApprovalHeaderBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i112.RouteForScCubit>(
        () => _i112.RouteForScCubit(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i113.SalesOrderCountBloc>(
        () => _i113.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i114.SalesOrderDetailsBloc>(
        () => _i114.SalesOrderDetailsBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i115.SchduledReturnApprovalBloc>(() =>
        _i115.SchduledReturnApprovalBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i116.SchduledReturnHeaderBloc>(() =>
        _i116.SchduledReturnHeaderBloc(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i117.ScheduledReturnDetailsBloc>(() =>
        _i117.ScheduledReturnDetailsBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i118.SettlementApprovalHeaderBloc>(() =>
        _i118.SettlementApprovalHeaderBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i119.SettlementApprovalHeaderBloc>(() =>
        _i119.SettlementApprovalHeaderBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i120.SettlementApprovalRejectBloc>(() =>
        _i120.SettlementApprovalRejectBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i121.SettlementCashDetailsBloc>(() =>
        _i121.SettlementCashDetailsBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i122.SettlementPayModeDetailBloc>(() =>
        _i122.SettlementPayModeDetailBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i123.SettlementPaymentDetailBloc>(() =>
        _i123.SettlementPaymentDetailBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i124.SpecialPriceCustomersBloc>(
        () => _i124.SpecialPriceCustomersBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i125.SpecialPriceDetailsBloc>(
        () => _i125.SpecialPriceDetailsBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i126.SpecialPriceHeaderBloc>(
        () => _i126.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i127.TargerHeaderListBloc>(
        () => _i127.TargerHeaderListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i128.TargetDetailsCountBloc>(
        () => _i128.TargetDetailsCountBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i129.TargetDetailsGraphAmtBloc>(
        () => _i129.TargetDetailsGraphAmtBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i130.TargetDetailsListBloc>(
        () => _i130.TargetDetailsListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i131.TargetHeaderCountBloc>(
        () => _i131.TargetHeaderCountBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i132.TargetPackageListBloc>(
        () => _i132.TargetPackageListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i133.TodaysDeliveryDetailsBloc>(
        () => _i133.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i134.TodaysDeliveryHeaderBloc>(
        () => _i134.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i135.TotalOrdersDetailsBloc>(
        () => _i135.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i136.TotalOrdersHeaderBloc>(
        () => _i136.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i137.UpdateGeoLocationCubit>(
        () => _i137.UpdateGeoLocationCubit(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i138.UserLoginBloc>(
        () => _i138.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i139.VanToVanApprovalBloc>(
        () => _i139.VanToVanApprovalBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i140.VanToVanDetailsBloc>(
        () => _i140.VanToVanDetailsBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i141.VanToVanHeaderBloc>(
        () => _i141.VanToVanHeaderBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i142.VoidTransactionApprovalBloc>(() =>
        _i142.VoidTransactionApprovalBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i143.VoidTransactionHeaderBloc>(
        () => _i143.VoidTransactionHeaderBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i144.VoidTransactionRejectionBloc>(() =>
        _i144.VoidTransactionRejectionBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i145.AllUsersBloc>(
        () => _i145.AllUsersBloc(gh<_i8.IChatUserRepo>()));
    gh.factory<_i146.ApprovalCountsBloc>(
        () => _i146.ApprovalCountsBloc(gh<_i3.IApprovalCountsRepo>()));
    gh.factory<_i147.ApprovalReasonsBloc>(
        () => _i147.ApprovalReasonsBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i148.ApprovePriceChangeBloc>(
        () => _i148.ApprovePriceChangeBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i149.ApproveReturnProductBloc>(
        () => _i149.ApproveReturnProductBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i150.ArDetailsBloc>(
        () => _i150.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i151.ArHeaderBloc>(
        () => _i151.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i152.AssetAddInApprovalHeaderBloc>(() =>
        _i152.AssetAddInApprovalHeaderBloc(gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i153.AssetAddingApprovalAndRjectBlocBloc>(() =>
        _i153.AssetAddingApprovalAndRjectBlocBloc(
            gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i154.AssetRemovalApprvalBloc>(() =>
        _i154.AssetRemovalApprvalBloc(gh<_i3.IAssetRemovalRequestRepo>()));
    gh.factory<_i155.AssetRemovelRequestHeaderBloc>(() =>
        _i155.AssetRemovelRequestHeaderBloc(
            gh<_i3.IAssetRemovalRequestRepo>()));
    gh.factory<_i156.CreditNoteApprovalAndRejectBloc>(() =>
        _i156.CreditNoteApprovalAndRejectBloc(
            gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i157.CreditNoteApprovalLevelStatusCubit>(() =>
        _i157.CreditNoteApprovalLevelStatusCubit(
            gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i158.CreditNoteDetailBloc>(
        () => _i158.CreditNoteDetailBloc(gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i159.CreditNoteHeaderBloc>(
        () => _i159.CreditNoteHeaderBloc(gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i160.CusDocumentsBloc>(
        () => _i160.CusDocumentsBloc(gh<_i3.IcusDocumentsModel>()));
    gh.factory<_i161.CusGeoLocationBloc>(
        () => _i161.CusGeoLocationBloc(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i162.CusInsArHeaderBloc>(
        () => _i162.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i163.CusInsInvoiceHeaderBloc>(
        () => _i163.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i164.CusInsTrnCountBloc>(
        () => _i164.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i165.CusInvDetailBlocBloc>(
        () => _i165.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i166.CusItemsBloc>(
        () => _i166.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i167.CusOutStandingBloc>(
        () => _i167.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i168.CusProfileBloc>(
        () => _i168.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i169.CusPromoDetailBloc>(
        () => _i169.CusPromoDetailBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i170.CusPromotionsHeaderBloc>(
        () => _i170.CusPromotionsHeaderBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i171.CusSalesOrdersBloc>(
        () => _i171.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i172.CusSpPriceBloc>(
        () => _i172.CusSpPriceBloc(gh<_i3.ICusSpPriceRepo>()));
    gh.factory<_i173.CustomerInsightGroupBloc>(
        () => _i173.CustomerInsightGroupBloc(gh<_i3.ICusInsightGroupRepo>()));
    gh.factory<_i174.CustomerTransactionBloc>(() =>
        _i174.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i175.CustomersListBlocBloc>(
        () => _i175.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    ...
    gh.factory<_i177.DisputeNoteApprovalAndRejectBloc>(() =>
        _i177.DisputeNoteApprovalAndRejectBloc(
            gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i178.DisputeNoteDetailBloc>(
        () => _i178.DisputeNoteDetailBloc(gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i179.DisputeNoteHeaderBloc>(
        () => _i179.DisputeNoteHeaderBloc(gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i180.EditCusProfileBloc>(
        () => _i180.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    gh.factory<_i181.FIeldServiceDetailBloc>(() => _i181.FIeldServiceDetailBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i182.FieldServiceHeaderBloc>(() => _i182.FieldServiceHeaderBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i183.FieldServiceInvoiceApprovalBloc>(() =>
        _i183.FieldServiceInvoiceApprovalBloc(
            gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i184.GetAllRouteBloc>(
        () => _i184.GetAllRouteBloc(gh<_i3.IGetAllAvailableRoutesRepo>()));
    return this;
  }
}
