...
import 'package:customer_connect/feature/domain/chat/getallusersrepo.dart'
    as _i60;
import 'package:customer_connect/feature/domain/chat/messagesrepo.dart' as _i97;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i27.InvoiceDetailsBloc>(
        () => _i27.InvoiceDetailsBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i28.InvoiceDetailsFooterBloc>(
        () => _i28.InvoiceDetailsFooterBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i29.InvoiceHeaderBloc>(
        () => _i29.InvoiceHeaderBloc(gh<_i3.IInvoiceRepo>()));
    gh.lazySingleton<_i3.IPromotionHeaderRepo>(
        () => _i30.PromotionHeaderRepo());
    gh.lazySingleton<_i3.ITrackSalesManRepo>(() => _i31.TrackSalesManRepo());
    gh.lazySingleton<_i3.INotificationRepo>(() => _i32.NotificationRepo());
    gh.lazySingleton<_i3.ISalesOrdersRepo>(() => _i33.SalesOrdersRepo());
    gh.factory<_i34.FIeldServiceDetailBloc>(() => _i34.FIeldServiceDetailBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i35.FieldServiceHeaderBloc>(() => _i35.FieldServiceHeaderBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.lazySingleton<_i3.IcusDocumentsModel>(() => _i36.CusDocumentsRepo());
    gh.lazySingleton<_i3.IUnScheduledVisitApprovalRepo>(
        () => _i37.UnScheduledVisitApprovalRepo());
    gh.lazySingleton<_i3.IMerchDisplayAgreement>(
        () => _i38.MerchDisplayAgreementRepo());
    ...
    gh.lazySingleton<_i3.IMerchandiseTaskHeaderRepo>(
        () => _i41.MerchandiseTaskRepo());
    gh.factory<_i42.CusSalesOrdersBloc>(
        () => _i42.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.lazySingleton<_i3.IPickingAndLoadinCountRepo>(
        () => _i43.PickingAndLoadinCountRepo());
    gh.factory<_i44.ApprovePriceChangeBloc>(
        () => _i44.ApprovePriceChangeBloc(gh<_i3.IPriceChangeRepo>()));
    gh.lazySingleton<_i3.IArCollectionRepo>(() => _i45.ArCollectionRepo());
    gh.lazySingleton<_i3.ICreditNoteApprovalRepo>(
        () => _i46.CreditNoteApprovalRepo());
    gh.lazySingleton<_i3.ILoginRepo>(() => _i47.UserLoginRepo());
    gh.lazySingleton<_i3.ICusInsArRepo>(() => _i48.CusInsArRepo());
    gh.factory<_i49.AssetAddingApprovalAndRjectBlocBloc>(() =>
        _i49.AssetAddingApprovalAndRjectBlocBloc(
            gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i50.AssetAddInApprovalHeaderBloc>(() =>
        _i50.AssetAddInApprovalHeaderBloc(gh<_i3.IAssetAddApprovalRepo>()));
    gh.lazySingleton<_i3.ICusOutstandingRepo>(() => _i51.CusOutStandingRepo());
    gh.lazySingleton<_i3.IReturnApprovalRepo>(() => _i52.ReturnApprovalRepo());
    gh.lazySingleton<_i3.IApprovalCountsRepo>(() => _i53.ApprovalsCountRepo());
    gh.lazySingleton<_i3.ICustomerTransactionRepo>(
        () => _i54.CustomerTransactionRepo());
    gh.lazySingleton<_i3.IHomeChartsRepo>(() => _i55.HomeChartRepo());
    gh.factory<_i56.ChartNonProductiveBloc>(
        () => _i56.ChartNonProductiveBloc(gh<_i3.IHomeChartsRepo>()));
    gh.lazySingleton<_i3.ICusSpPriceRepo>(() => _i57.CusSpPriceRepo());
    gh.lazySingleton<_i3.ICusInsightGroupRepo>(
        () => _i58.CusInsightGroupRepo());
    gh.lazySingleton<_i59.IChatUserRepo>(() => _i60.AllUsersRepo());
    gh.factory<_i61.PromotionHeaderBloc>(
        () => _i61.PromotionHeaderBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.lazySingleton<_i3.ILoadRequestHeaderRepo>(
        () => _i62.LoadRequestHeaderRepo());
    gh.factory<_i63.MerchSurveyCountBloc>(
        () => _i63.MerchSurveyCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.lazySingleton<_i3.ISettlementApprovalHeaderRepo>(
        () => _i64.SettlementApproval());
    gh.lazySingleton<_i3.ICusInsightsCustomersRepo>(
        () => _i65.CusInsCustomersRepo());
    ...
    gh.lazySingleton<_i59.IMessageRepo>(() => _i97.MessagesRepo());
    ...
    gh.factory<_i111.MessagesBloc>(
        () => _i111.MessagesBloc(gh<_i59.IMessageRepo>()));
    ...
    gh.factory<_i156.AllUsersBloc>(
        () => _i156.AllUsersBloc(gh<_i59.IChatUserRepo>()));
