...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i46.PriceChangeHeaderBloc>(
        () => _i46.PriceChangeHeaderBloc(gh<_i3.IPriceChangeRepo>()));
    ...
    gh.factory<_i51.SalesOrderCountBloc>(
        () => _i51.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i52.SpecialPriceCustomersBloc>(
        () => _i52.SpecialPriceCustomersBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i53.SpecialPriceDetailsBloc>(
        () => _i53.SpecialPriceDetailsBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i54.SpecialPriceHeaderBloc>(
        () => _i54.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i55.TodaysDeliveryDetailsBloc>(
        () => _i55.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i56.TodaysDeliveryHeaderBloc>(
        () => _i56.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i57.TotalOrdersDetailsBloc>(
        () => _i57.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i58.TotalOrdersHeaderBloc>(
        () => _i58.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i59.UpdateGeoLocationCubit>(
        () => _i59.UpdateGeoLocationCubit(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i60.UserLoginBloc>(
        () => _i60.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i61.ArDetailsBloc>(
        () => _i61.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i62.ArHeaderBloc>(
        () => _i62.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i63.CusDocumentsBloc>(
        () => _i63.CusDocumentsBloc(gh<_i3.IcusDocumentsModel>()));
    gh.factory<_i64.CusGeoLocationBloc>(
        () => _i64.CusGeoLocationBloc(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i65.CusInsArHeaderBloc>(
        () => _i65.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i66.CusInsInvoiceHeaderBloc>(
        () => _i66.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i67.CusInsTrnCountBloc>(
        () => _i67.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i68.CusInvDetailBlocBloc>(
        () => _i68.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i69.CusItemsBloc>(
        () => _i69.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i70.CusOutStandingBloc>(
        () => _i70.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i71.CusProfileBloc>(
        () => _i71.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i72.CusPromoDetailBloc>(
        () => _i72.CusPromoDetailBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i73.CusPromotionsHeaderBloc>(
        () => _i73.CusPromotionsHeaderBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i74.CusSalesOrdersBloc>(
        () => _i74.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i75.CusSpPriceBloc>(
        () => _i75.CusSpPriceBloc(gh<_i3.ICusSpPriceRepo>()));
    gh.factory<_i76.CustomerTransactionBloc>(
        () => _i76.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i77.CustomersListBlocBloc>(
        () => _i77.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    gh.factory<_i78.EditCusProfileBloc>(
        () => _i78.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    return this;
  }
}
