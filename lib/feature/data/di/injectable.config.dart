...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.IPromotionHeaderRepo>(
        () => _i19.PromotionHeaderRepo());
    gh.lazySingleton<_i3.ISalesOrderRepo>(() => _i20.SalesOrderCountRepo());
    gh.lazySingleton<_i3.ISalesOrdersRepo>(() => _i21.SalesOrdersRepo());
    gh.lazySingleton<_i3.ISpecialPriceRepo>(() => _i22.SpecialPriceRepo());
    gh.lazySingleton<_i3.ITodaysDeliveryRepo>(() => _i23.TodaysDelivery());
    gh.lazySingleton<_i3.ITotalOrdersRepo>(() => _i24.TotalOrderRepo());
    gh.lazySingleton<_i3.IcusDocumentsModel>(() => _i25.CusDocumentsRepo());
    gh.lazySingleton<_i3.IcusInsCountsRepo>(() => _i26.CusTrnCOuntsRepo());
    ...
    gh.factory<_i32.LoadingHeaderBloc>(
        () => _i32.LoadingHeaderBloc(gh<_i3.ILoadingRepo>()));
    gh.factory<_i33.PickingAndLoadingCountBloc>(() =>
        _i33.PickingAndLoadingCountBloc(gh<_i3.IPickingAndLoadinCountRepo>()));
    gh.factory<_i34.PickingHeaderBloc>(
        () => _i34.PickingHeaderBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i35.PickingdetailBloc>(
        () => _i35.PickingdetailBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i36.PromotionCustomerBloc>(
        () => _i36.PromotionCustomerBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i37.PromotionDetailsBloc>(
        () => _i37.PromotionDetailsBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i38.PromotionHeaderBloc>(
        () => _i38.PromotionHeaderBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i39.SalesOrderCountBloc>(
        () => _i39.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i40.SpecialPriceHeaderBloc>(
        () => _i40.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i41.TodaysDeliveryDetailsBloc>(
        () => _i41.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i42.TodaysDeliveryHeaderBloc>(
        () => _i42.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i43.TotalOrdersDetailsBloc>(
        () => _i43.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i44.TotalOrdersHeaderBloc>(
        () => _i44.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i45.UpdateGeoLocationCubit>(
        () => _i45.UpdateGeoLocationCubit(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i46.UserLoginBloc>(
        () => _i46.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i47.ArDetailsBloc>(
        () => _i47.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i48.ArHeaderBloc>(
        () => _i48.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i49.CusDocumentsBloc>(
        () => _i49.CusDocumentsBloc(gh<_i3.IcusDocumentsModel>()));
    gh.factory<_i50.CusGeoLocationBloc>(
        () => _i50.CusGeoLocationBloc(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i51.CusInsArHeaderBloc>(
        () => _i51.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i52.CusInsInvoiceHeaderBloc>(
        () => _i52.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i53.CusInsTrnCountBloc>(
        () => _i53.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i54.CusInvDetailBlocBloc>(
        () => _i54.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i55.CusItemsBloc>(
        () => _i55.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i56.CusOutStandingBloc>(
        () => _i56.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i57.CusProfileBloc>(
        () => _i57.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i58.CusSalesOrdersBloc>(
        () => _i58.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i59.CustomerTransactionBloc>(
        () => _i59.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i60.CustomersListBlocBloc>(
        () => _i60.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    gh.factory<_i61.EditCusProfileBloc>(
        () => _i61.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    return this;
  }
}
