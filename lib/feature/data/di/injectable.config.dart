...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.IOutOfStockProductsRepo>(
        () => _i41.OutOfStockItemsRepo());
    gh.lazySingleton<_i3.IOutStandingHeaderRepo>(
        () => _i42.OutStandingHeadRepo());
    gh.lazySingleton<_i3.IPartialDeliveryRepo>(
        () => _i43.PartialDeliveryRepo());
    gh.lazySingleton<_i3.IPickingAndLoadinCountRepo>(
        () => _i44.PickingAndLoadinCountRepo());
    gh.lazySingleton<_i3.IPickingHeaderRepo>(() => _i45.PickingHeaderRepo());
    gh.lazySingleton<_i3.IPriceChangeRepo>(() => _i46.PriceChangeRepo());
    gh.lazySingleton<_i3.IProfileEditRepo>(() => _i47.ProfileEditingRepo());
    gh.lazySingleton<_i3.IPromotionHeaderRepo>(
        () => _i48.PromotionHeaderRepo());
    gh.lazySingleton<_i3.IQualificationGroupRepo>(
        () => _i49.QualificationGroupREpo());
    gh.lazySingleton<_i3.IReturnApprovalRepo>(() => _i50.ReturnApprovalRepo());
    gh.lazySingleton<_i3.ISalesOrderRepo>(() => _i51.SalesOrderCountRepo());
    gh.lazySingleton<_i3.ISalesOrdersRepo>(() => _i52.SalesOrdersRepo());
    gh.lazySingleton<_i3.IScheduledReturnApprovalRepo>(
        () => _i53.ScheduledReturnApprovalRepo());
    gh.lazySingleton<_i3.ISettlementApprovalHeaderRepo>(
        () => _i54.SettlementApproval());
    gh.lazySingleton<_i3.ISpecialPriceRepo>(() => _i55.SpecialPriceRepo());
    gh.lazySingleton<_i3.ITargetRepo>(() => _i56.TargetHeaderCountRepo());
    gh.lazySingleton<_i3.ITodaysDeliveryRepo>(() => _i57.TodaysDelivery());
    gh.lazySingleton<_i3.ITotalOrdersRepo>(() => _i58.TotalOrderRepo());
    gh.lazySingleton<_i3.ITrackSalesManRepo>(() => _i59.TrackSalesManRepo());
    gh.lazySingleton<_i3.IVanToVanApprovalRepo>(
        () => _i60.VanToVanApprovalRepo());
    gh.lazySingleton<_i3.IVoidTransactionRepo>(
        () => _i61.VoidTransactionHeaderRepo());
    gh.lazySingleton<_i3.IcusDocumentsModel>(() => _i62.CusDocumentsRepo());
    gh.lazySingleton<_i3.IcusInsCountsRepo>(() => _i63.CusTrnCOuntsRepo());
    gh.lazySingleton<_i3.IinvetoryReconfirmationApprovalRepo>(
        () => _i64.InventoryReconfirmationRepo());
    gh.factory<_i65.InventoryReconfirmApprovalBloc>(() =>
        _i65.InventoryReconfirmApprovalBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i66.InventoryReconfirmDetailBloc>(() =>
        _i66.InventoryReconfirmDetailBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i67.InventoryReconfirmHeaderBloc>(() =>
        _i67.InventoryReconfirmHeaderBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i68.InventoryReconfirmReasonsCubit>(() =>
        _i68.InventoryReconfirmReasonsCubit(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i69.InvoiceDetailsBloc>(
        () => _i69.InvoiceDetailsBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i70.InvoiceDetailsFooterBloc>(
        () => _i70.InvoiceDetailsFooterBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i71.InvoiceHeaderBloc>(
        () => _i71.InvoiceHeaderBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i72.JoureyPlanApprovalBloc>(
        () => _i72.JoureyPlanApprovalBloc(gh<_i3.IJourneyPlanApprovalRepo>()));
    gh.factory<_i73.JourneyPlanHeaderBloc>(
        () => _i73.JourneyPlanHeaderBloc(gh<_i3.IJourneyPlanApprovalRepo>()));
    gh.factory<_i74.LoadReqApprovalBloc>(
        () => _i74.LoadReqApprovalBloc(gh<_i3.ILoadRequestApprovalRepo>()));
    gh.factory<_i75.LoadReqDetailBloc>(
        () => _i75.LoadReqDetailBloc(gh<_i3.ILoadRequestHeaderRepo>()));
    gh.factory<_i76.LoadReqHeaderBloc>(
        () => _i76.LoadReqHeaderBloc(gh<_i3.ILoadRequestHeaderRepo>()));
    gh.factory<_i77.LoadTransferApprovalBloc>(() =>
        _i77.LoadTransferApprovalBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    gh.factory<_i78.LoadTransferDetailBloc>(
        () => _i78.LoadTransferDetailBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    gh.factory<_i79.LoadTransferHeaderBloc>(
        () => _i79.LoadTransferHeaderBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    ...
    gh.factory<_i83.MaterialReqApprovalBloc>(
        () => _i83.MaterialReqApprovalBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i84.MaterialReqDetailBloc>(
        () => _i84.MaterialReqDetailBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i85.MaterialReqHeadBloc>(
        () => _i85.MaterialReqHeadBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i86.MaterialReqRejectionBloc>(
        () => _i86.MaterialReqRejectionBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i87.MerchandisingSurveyBloc>(() =>
        _i87.MerchandisingSurveyBloc(gh<_i3.IMerchandinsingSurveyRepo>()));
    gh.factory<_i88.MessagesBloc>(
        () => _i88.MessagesBloc(gh<_i9.IMessageRepo>()));
    gh.factory<_i89.MustSellApproveBloc>(
        () => _i89.MustSellApproveBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i90.MustSellDetailBloc>(
        () => _i90.MustSellDetailBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i91.MustSellHeaderBloc>(
        () => _i91.MustSellHeaderBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i92.NotiReadFlagUpdateBloc>(
        () => _i92.NotiReadFlagUpdateBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i93.NotificationListingBloc>(
        () => _i93.NotificationListingBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i94.NotificationReplayBlocBloc>(
        () => _i94.NotificationReplayBlocBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i95.OutOfStockItemCustomersBloc>(() =>
        _i95.OutOfStockItemCustomersBloc(gh<_i3.IOutOfStockProductsRepo>()));
    gh.factory<_i96.OutOfStockItemsBloc>(
        () => _i96.OutOfStockItemsBloc(gh<_i3.IOutOfStockProductsRepo>()));
    gh.factory<_i97.OutofstockcountBloc>(
        () => _i97.OutofstockcountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i98.OutstandingBloc>(
        () => _i98.OutstandingBloc(gh<_i3.IOutStandingHeaderRepo>()));
    gh.factory<_i99.PartialDeliveryApprovalBloc>(
        () => _i99.PartialDeliveryApprovalBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i100.PartialDeliveryDetailBloc>(
        () => _i100.PartialDeliveryDetailBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i101.PartialDeliveryDetailsBloc>(
        () => _i101.PartialDeliveryDetailsBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i102.PartialDeliveryHeaderBloc>(
        () => _i102.PartialDeliveryHeaderBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i103.PartialDeliveryReasonBloc>(
        () => _i103.PartialDeliveryReasonBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i104.PartialDeliveryReasonCubit>(
        () => _i104.PartialDeliveryReasonCubit(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i105.PickingAndLoadingCountBloc>(() =>
        _i105.PickingAndLoadingCountBloc(gh<_i3.IPickingAndLoadinCountRepo>()));
    gh.factory<_i106.PickingHeaderBloc>(
        () => _i106.PickingHeaderBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i107.PickingdetailBloc>(
        () => _i107.PickingdetailBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i108.PostSettlementApprovalBloc>(() =>
        _i108.PostSettlementApprovalBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i109.PriceChangeDetailsBloc>(
        () => _i109.PriceChangeDetailsBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i110.PriceChangeHeaderBloc>(
        () => _i110.PriceChangeHeaderBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i111.PriceChangeReasonsBloc>(
        () => _i111.PriceChangeReasonsBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i112.PromotionCustomerBloc>(
        () => _i112.PromotionCustomerBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i113.PromotionDetailsBloc>(
        () => _i113.PromotionDetailsBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i114.PromotionHeaderBloc>(
        () => _i114.PromotionHeaderBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i115.QualificationGroupBloc>(
        () => _i115.QualificationGroupBloc(gh<_i3.IQualificationGroupRepo>()));
    gh.factory<_i116.RargetDetailsGraphQtyBloc>(
        () => _i116.RargetDetailsGraphQtyBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i117.ReturnApprovalDetailBloc>(
        () => _i117.ReturnApprovalDetailBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i118.ReturnApprovalHeaderBloc>(
        () => _i118.ReturnApprovalHeaderBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i119.RouteForScCubit>(
        () => _i119.RouteForScCubit(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i120.SalesOrderCountBloc>(
        () => _i120.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i121.SalesOrderDetailsBloc>(
        () => _i121.SalesOrderDetailsBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i122.SchduledReturnApprovalBloc>(() =>
        _i122.SchduledReturnApprovalBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i123.SchduledReturnHeaderBloc>(() =>
        _i123.SchduledReturnHeaderBloc(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i124.ScheduledReturnDetailsBloc>(() =>
        _i124.ScheduledReturnDetailsBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i125.SettlementApprovalHeaderBloc>(() =>
        _i125.SettlementApprovalHeaderBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i126.SettlementApprovalHeaderBloc>(() =>
        _i126.SettlementApprovalHeaderBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i127.SettlementApprovalRejectBloc>(() =>
        _i127.SettlementApprovalRejectBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i128.SettlementCashDetailsBloc>(() =>
        _i128.SettlementCashDetailsBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i129.SettlementPayModeDetailBloc>(() =>
        _i129.SettlementPayModeDetailBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i130.SettlementPaymentDetailBloc>(() =>
        _i130.SettlementPaymentDetailBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i131.SpecialPriceCustomersBloc>(
        () => _i131.SpecialPriceCustomersBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i132.SpecialPriceDetailsBloc>(
        () => _i132.SpecialPriceDetailsBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i133.SpecialPriceHeaderBloc>(
        () => _i133.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i134.TargerHeaderListBloc>(
        () => _i134.TargerHeaderListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i135.TargetDetailsCountBloc>(
        () => _i135.TargetDetailsCountBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i136.TargetDetailsGraphAmtBloc>(
        () => _i136.TargetDetailsGraphAmtBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i137.TargetDetailsListBloc>(
        () => _i137.TargetDetailsListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i138.TargetHeaderCountBloc>(
        () => _i138.TargetHeaderCountBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i139.TargetPackageListBloc>(
        () => _i139.TargetPackageListBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i140.TodaysDeliveryDetailsBloc>(
        () => _i140.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i141.TodaysDeliveryHeaderBloc>(
        () => _i141.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i142.TotalOrdersDetailsBloc>(
        () => _i142.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i143.TotalOrdersHeaderBloc>(
        () => _i143.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i144.TrackSalesManListBloc>(
        () => _i144.TrackSalesManListBloc(gh<_i3.ITrackSalesManRepo>()));
    gh.factory<_i145.UpdateGeoLocationCubit>(
        () => _i145.UpdateGeoLocationCubit(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i146.UserLoginBloc>(
        () => _i146.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i147.VanToVanApprovalBloc>(
        () => _i147.VanToVanApprovalBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i148.VanToVanDetailsBloc>(
        () => _i148.VanToVanDetailsBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i149.VanToVanHeaderBloc>(
        () => _i149.VanToVanHeaderBloc(gh<_i3.IVanToVanApprovalRepo>()));
    gh.factory<_i150.VoidTransactionApprovalBloc>(() =>
        _i150.VoidTransactionApprovalBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i151.VoidTransactionHeaderBloc>(
        () => _i151.VoidTransactionHeaderBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i152.VoidTransactionRejectionBloc>(() =>
        _i152.VoidTransactionRejectionBloc(gh<_i3.IVoidTransactionRepo>()));
    gh.factory<_i153.ActivityReviewDetailBloc>(
        () => _i153.ActivityReviewDetailBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i154.ActivityReviewHeaderBloc>(
        () => _i154.ActivityReviewHeaderBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i155.ActivityReviewSalesDataBloc>(
        () => _i155.ActivityReviewSalesDataBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i156.ActivityReviewTargetsBloc>(
        () => _i156.ActivityReviewTargetsBloc(gh<_i3.IActivityReviewRepo>()));
    gh.factory<_i157.AllUsersBloc>(
        () => _i157.AllUsersBloc(gh<_i9.IChatUserRepo>()));
    gh.factory<_i158.ApprovalCountsBloc>(
        () => _i158.ApprovalCountsBloc(gh<_i3.IApprovalCountsRepo>()));
    gh.factory<_i159.ApprovalReasonsBloc>(
        () => _i159.ApprovalReasonsBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i160.ApprovePriceChangeBloc>(
        () => _i160.ApprovePriceChangeBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i161.ApproveReturnProductBloc>(
        () => _i161.ApproveReturnProductBloc(gh<_i3.IReturnApprovalRepo>()));
    gh.factory<_i162.ArDetailsBloc>(
        () => _i162.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i163.ArHeaderBloc>(
        () => _i163.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i164.AssetAddInApprovalHeaderBloc>(() =>
        _i164.AssetAddInApprovalHeaderBloc(gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i165.AssetAddingApprovalAndRjectBlocBloc>(() =>
        _i165.AssetAddingApprovalAndRjectBlocBloc(
            gh<_i3.IAssetAddApprovalRepo>()));
    gh.factory<_i166.AssetRemovalApprvalBloc>(() =>
        _i166.AssetRemovalApprvalBloc(gh<_i3.IAssetRemovalRequestRepo>()));
    gh.factory<_i167.AssetRemovelRequestHeaderBloc>(() =>
        _i167.AssetRemovelRequestHeaderBloc(
            gh<_i3.IAssetRemovalRequestRepo>()));
    gh.factory<_i168.ChartActualVisitsBloc>(
        () => _i168.ChartActualVisitsBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i169.ChartNonProductiveBloc>(
        () => _i169.ChartNonProductiveBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i170.ChartPlannedVisitsBloc>(
        () => _i170.ChartPlannedVisitsBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i171.ChartProductiveVisitBloc>(
        () => _i171.ChartProductiveVisitBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i172.ChartRoutsBloc>(
        () => _i172.ChartRoutsBloc(gh<_i3.IHomeChartsRepo>()));
    gh.factory<_i173.CreditNoteApprovalAndRejectBloc>(() =>
        _i173.CreditNoteApprovalAndRejectBloc(
            gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i174.CreditNoteApprovalLevelStatusCubit>(() =>
        _i174.CreditNoteApprovalLevelStatusCubit(
            gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i175.CreditNoteDetailBloc>(
        () => _i175.CreditNoteDetailBloc(gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i176.CreditNoteHeaderBloc>(
        () => _i176.CreditNoteHeaderBloc(gh<_i3.ICreditNoteApprovalRepo>()));
    gh.factory<_i177.CusDocumentsBloc>(
        () => _i177.CusDocumentsBloc(gh<_i3.IcusDocumentsModel>()));
    gh.factory<_i178.CusGeoLocationBloc>(
        () => _i178.CusGeoLocationBloc(gh<_i3.ICusGeoLocationRepo>()));
    gh.factory<_i179.CusInsArHeaderBloc>(
        () => _i179.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i180.CusInsInvoiceHeaderBloc>(
        () => _i180.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i181.CusInsTrnCountBloc>(
        () => _i181.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i182.CusInvDetailBlocBloc>(
        () => _i182.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i183.CusItemsBloc>(
        () => _i183.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i184.CusOutStandingBloc>(
        () => _i184.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i185.CusProfileBloc>(
        () => _i185.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i186.CusPromoDetailBloc>(
        () => _i186.CusPromoDetailBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i187.CusPromotionsHeaderBloc>(
        () => _i187.CusPromotionsHeaderBloc(gh<_i3.ICusProtionRepo>()));
    gh.factory<_i188.CusSalesOrdersBloc>(
        () => _i188.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i189.CusSpPriceBloc>(
        () => _i189.CusSpPriceBloc(gh<_i3.ICusSpPriceRepo>()));
    gh.factory<_i190.CustomerInsightGroupBloc>(
        () => _i190.CustomerInsightGroupBloc(gh<_i3.ICusInsightGroupRepo>()));
    gh.factory<_i191.CustomerSettingsBloc>(
        () => _i191.CustomerSettingsBloc(gh<_i3.ICustomerSettingsRepo>()));
    gh.factory<_i192.CustomerTransactionBloc>(() =>
        _i192.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i193.CustomersListBlocBloc>(
        () => _i193.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    gh.factory<_i194.DisputeApprovalStatusLevelCubitCubit>(() =>
        _i194.DisputeApprovalStatusLevelCubitCubit(
            gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i195.DisputeNoteApprovalAndRejectBloc>(() =>
        _i195.DisputeNoteApprovalAndRejectBloc(
            gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i196.DisputeNoteDetailBloc>(
        () => _i196.DisputeNoteDetailBloc(gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i197.DisputeNoteHeaderBloc>(
        () => _i197.DisputeNoteHeaderBloc(gh<_i3.IDisputeNoteApprovalRepo>()));
    gh.factory<_i198.EditCusProfileBloc>(
        () => _i198.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    gh.factory<_i199.FIeldServiceDetailBloc>(() => _i199.FIeldServiceDetailBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i200.FieldServiceHeaderBloc>(() => _i200.FieldServiceHeaderBloc(
        gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i201.FieldServiceInvoiceApprovalBloc>(() =>
        _i201.FieldServiceInvoiceApprovalBloc(
            gh<_i3.IFieldServiceInvoiceApprovalRepo>()));
    gh.factory<_i202.GetAllRouteBloc>(
        () => _i202.GetAllRouteBloc(gh<_i3.IGetAllAvailableRoutesRepo>()));
    return this;
  }
}
