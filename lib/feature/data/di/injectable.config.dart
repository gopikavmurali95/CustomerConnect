...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i35.PromotionCustomerBloc>(
        () => _i35.PromotionCustomerBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i36.PromotionDetailsBloc>(
        () => _i36.PromotionDetailsBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i37.PromotionHeaderBloc>(
        () => _i37.PromotionHeaderBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i38.SalesOrderCountBloc>(
        () => _i38.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i39.SpecialPriceHeaderBloc>(
        () => _i39.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i40.TodaysDeliveryDetailsBloc>(
        () => _i40.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i41.TodaysDeliveryHeaderBloc>(
        () => _i41.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i42.TotalOrdersDetailsBloc>(
        () => _i42.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i43.TotalOrdersHeaderBloc>(
        () => _i43.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i44.UserLoginBloc>(
        () => _i44.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i45.ArDetailsBloc>(
        () => _i45.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i46.ArHeaderBloc>(
        () => _i46.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i47.CusDocumentsBloc>(
        () => _i47.CusDocumentsBloc(gh<_i3.IcusDocumentsModel>()));
    gh.factory<_i48.CusInsArHeaderBloc>(
        () => _i48.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i49.CusInsInvoiceHeaderBloc>(
        () => _i49.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i50.CusInsTrnCountBloc>(
        () => _i50.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i51.CusInvDetailBlocBloc>(
        () => _i51.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i52.CusItemsBloc>(
        () => _i52.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i53.CusOutStandingBloc>(
        () => _i53.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i54.CusProfileBloc>(
        () => _i54.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i55.CusSalesOrdersBloc>(
        () => _i55.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i56.CustomerTransactionBloc>(
        () => _i56.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i57.CustomersListBlocBloc>(
        () => _i57.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    gh.factory<_i58.EditCusProfileBloc>(
        () => _i58.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    return this;
  }
}
