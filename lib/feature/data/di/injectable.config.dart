...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.IcusInsCountsRepo>(() => _i23.CusTrnCOuntsRepo());
    gh.factory<_i24.InvoiceDetailsBloc>(
        () => _i24.InvoiceDetailsBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i25.InvoiceDetailsFooterBloc>(
        () => _i25.InvoiceDetailsFooterBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i26.InvoiceHeaderBloc>(
        () => _i26.InvoiceHeaderBloc(gh<_i3.IInvoiceRepo>()));
    ...
    gh.factory<_i29.LoadingHeaderBloc>(
        () => _i29.LoadingHeaderBloc(gh<_i3.ILoadingRepo>()));
    gh.factory<_i30.PickingAndLoadingCountBloc>(() =>
        _i30.PickingAndLoadingCountBloc(gh<_i3.IPickingAndLoadinCountRepo>()));
    gh.factory<_i31.PickingHeaderBloc>(
        () => _i31.PickingHeaderBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i32.PickingdetailBloc>(
        () => _i32.PickingdetailBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i33.SalesOrderCountBloc>(
        () => _i33.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i34.SpecialPriceHeaderBloc>(
        () => _i34.SpecialPriceHeaderBloc(gh<_i3.ISpecialPriceRepo>()));
    gh.factory<_i35.TodaysDeliveryDetailsBloc>(
        () => _i35.TodaysDeliveryDetailsBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i36.TodaysDeliveryHeaderBloc>(
        () => _i36.TodaysDeliveryHeaderBloc(gh<_i3.ITodaysDeliveryRepo>()));
    gh.factory<_i37.TotalOrdersDetailsBloc>(
        () => _i37.TotalOrdersDetailsBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i38.TotalOrdersHeaderBloc>(
        () => _i38.TotalOrdersHeaderBloc(gh<_i3.ITotalOrdersRepo>()));
    gh.factory<_i39.UserLoginBloc>(
        () => _i39.UserLoginBloc(gh<_i3.ILoginRepo>()));
    gh.factory<_i40.ArDetailsBloc>(
        () => _i40.ArDetailsBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i41.ArHeaderBloc>(
        () => _i41.ArHeaderBloc(gh<_i3.IArCollectionRepo>()));
    gh.factory<_i42.CusInsArHeaderBloc>(
        () => _i42.CusInsArHeaderBloc(gh<_i3.ICusInsArRepo>()));
    gh.factory<_i43.CusInsInvoiceHeaderBloc>(
        () => _i43.CusInsInvoiceHeaderBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i44.CusInsTrnCountBloc>(
        () => _i44.CusInsTrnCountBloc(gh<_i3.IcusInsCountsRepo>()));
    gh.factory<_i45.CusInvDetailBlocBloc>(
        () => _i45.CusInvDetailBlocBloc(gh<_i3.ICusInsInvoiceRepo>()));
    gh.factory<_i46.CusItemsBloc>(
        () => _i46.CusItemsBloc(gh<_i3.ICusItemsRepo>()));
    gh.factory<_i47.CusOutStandingBloc>(
        () => _i47.CusOutStandingBloc(gh<_i3.ICusOutstandingRepo>()));
    gh.factory<_i48.CusProfileBloc>(
        () => _i48.CusProfileBloc(gh<_i3.ICusProfileRepo>()));
    gh.factory<_i49.CusSalesOrdersBloc>(
        () => _i49.CusSalesOrdersBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i50.CustomerTransactionBloc>(
        () => _i50.CustomerTransactionBloc(gh<_i3.ICustomerTransactionRepo>()));
    gh.factory<_i51.CustomersListBlocBloc>(
        () => _i51.CustomersListBlocBloc(gh<_i3.ICusInsightsCustomersRepo>()));
    gh.factory<_i52.EditCusProfileBloc>(
        () => _i52.EditCusProfileBloc(gh<_i3.IProfileEditRepo>()));
    return this;
  }
}
