...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.IOutOfStockProductsRepo>(
        () => _i44.OutOfStockItemsRepo());
    gh.lazySingleton<_i3.IOutStandingHeaderRepo>(
        () => _i45.OutStandingHeadRepo());
    ...
    gh.lazySingleton<_i3.IPickingHeaderRepo>(() => _i48.PickingHeaderRepo());
    gh.lazySingleton<_i3.IPriceChangeRepo>(() => _i49.PriceChangeRepo());
    gh.lazySingleton<_i3.IProfileEditRepo>(() => _i50.ProfileEditingRepo());
    gh.lazySingleton<_i3.IPromotionHeaderRepo>(
        () => _i51.PromotionHeaderRepo());
    gh.lazySingleton<_i3.IQualificationGroupRepo>(
        () => _i52.QualificationGroupREpo());
    gh.lazySingleton<_i3.IReturnApprovalRepo>(() => _i53.ReturnApprovalRepo());
    gh.lazySingleton<_i3.ISalesOrderRepo>(() => _i54.SalesOrderCountRepo());
    gh.lazySingleton<_i3.ISalesOrdersRepo>(() => _i55.SalesOrdersRepo());
    gh.lazySingleton<_i3.IScheduledReturnApprovalRepo>(
        () => _i56.ScheduledReturnApprovalRepo());
    gh.lazySingleton<_i3.ISettlementApprovalHeaderRepo>(
        () => _i57.SettlementApproval());
    gh.lazySingleton<_i3.ISpecialPriceRepo>(() => _i58.SpecialPriceRepo());
    gh.lazySingleton<_i3.ITargetRepo>(() => _i59.TargetHeaderCountRepo());
    gh.lazySingleton<_i3.ITodaysDeliveryRepo>(() => _i60.TodaysDelivery());
    gh.lazySingleton<_i3.ITotalOrdersRepo>(() => _i61.TotalOrderRepo());
    gh.lazySingleton<_i3.ITrackSalesManRepo>(() => _i62.TrackSalesManRepo());
    gh.lazySingleton<_i3.IVanToVanApprovalRepo>(
        () => _i63.VanToVanApprovalRepo());
    gh.lazySingleton<_i3.IVoidTransactionRepo>(
        () => _i64.VoidTransactionHeaderRepo());
    gh.lazySingleton<_i3.IcusDocumentsModel>(() => _i65.CusDocumentsRepo());
    gh.lazySingleton<_i3.IcusInsCountsRepo>(() => _i66.CusTrnCOuntsRepo());
    gh.lazySingleton<_i3.IinvetoryReconfirmationApprovalRepo>(
        () => _i67.InventoryReconfirmationRepo());
    gh.factory<_i68.InventoryReconfirmApprovalBloc>(() =>
        _i68.InventoryReconfirmApprovalBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i69.InventoryReconfirmDetailBloc>(() =>
        _i69.InventoryReconfirmDetailBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i70.InventoryReconfirmHeaderBloc>(() =>
        _i70.InventoryReconfirmHeaderBloc(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i71.InventoryReconfirmReasonsCubit>(() =>
        _i71.InventoryReconfirmReasonsCubit(
            gh<_i3.IinvetoryReconfirmationApprovalRepo>()));
    gh.factory<_i72.InvoiceDetailsBloc>(
        () => _i72.InvoiceDetailsBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i73.InvoiceDetailsFooterBloc>(
        () => _i73.InvoiceDetailsFooterBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i74.InvoiceHeaderBloc>(
        () => _i74.InvoiceHeaderBloc(gh<_i3.IInvoiceRepo>()));
    gh.factory<_i75.JoureyPlanApprovalBloc>(
        () => _i75.JoureyPlanApprovalBloc(gh<_i3.IJourneyPlanApprovalRepo>()));
    gh.factory<_i76.JourneyPlanHeaderBloc>(
        () => _i76.JourneyPlanHeaderBloc(gh<_i3.IJourneyPlanApprovalRepo>()));
    gh.factory<_i77.LoadReqApprovalBloc>(
        () => _i77.LoadReqApprovalBloc(gh<_i3.ILoadRequestApprovalRepo>()));
    gh.factory<_i78.LoadReqDetailBloc>(
        () => _i78.LoadReqDetailBloc(gh<_i3.ILoadRequestHeaderRepo>()));
    gh.factory<_i79.LoadReqHeaderBloc>(
        () => _i79.LoadReqHeaderBloc(gh<_i3.ILoadRequestHeaderRepo>()));
    gh.factory<_i80.LoadTransferApprovalBloc>(() =>
        _i80.LoadTransferApprovalBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    gh.factory<_i81.LoadTransferDetailBloc>(
        () => _i81.LoadTransferDetailBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    gh.factory<_i82.LoadTransferHeaderBloc>(
        () => _i82.LoadTransferHeaderBloc(gh<_i3.ILoadTransferApprovalRepo>()));
    ...
    gh.factory<_i85.LoadingHeaderBloc>(
        () => _i85.LoadingHeaderBloc(gh<_i3.ILoadingRepo>()));
    gh.factory<_i86.MaterialReqApprovalBloc>(
        () => _i86.MaterialReqApprovalBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i87.MaterialReqDetailBloc>(
        () => _i87.MaterialReqDetailBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i88.MaterialReqHeadBloc>(
        () => _i88.MaterialReqHeadBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i89.MaterialReqRejectionBloc>(
        () => _i89.MaterialReqRejectionBloc(gh<_i3.IMaterialReqHeaderRepo>()));
    gh.factory<_i90.MerchCusActCountBloc>(
        () => _i90.MerchCusActCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i91.MerchCustomerActivitiesBloc>(() =>
        _i91.MerchCustomerActivitiesBloc(
            gh<_i3.IMerchCustomerActivitiesRepo>()));
    gh.factory<_i92.MerchDisplayAgreementBloc>(
        () => _i92.MerchDisplayAgreementBloc(gh<_i3.IMerchDisplayAgreement>()));
    gh.factory<_i93.MerchSurveyCountBloc>(
        () => _i93.MerchSurveyCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i94.MerchTaskCountBloc>(
        () => _i94.MerchTaskCountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i95.MerchandTaskHeaderBloc>(() =>
        _i95.MerchandTaskHeaderBloc(gh<_i3.IMerchandiseTaskHeaderRepo>()));
    gh.factory<_i96.MerchandisingSurveyBloc>(() =>
        _i96.MerchandisingSurveyBloc(gh<_i3.IMerchandinsingSurveyRepo>()));
    gh.factory<_i97.MerchdisplaycountBloc>(() =>
        _i97.MerchdisplaycountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i98.MessagesBloc>(
        () => _i98.MessagesBloc(gh<_i9.IMessageRepo>()));
    gh.factory<_i99.MustSellApproveBloc>(
        () => _i99.MustSellApproveBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i100.MustSellDetailBloc>(
        () => _i100.MustSellDetailBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i101.MustSellHeaderBloc>(
        () => _i101.MustSellHeaderBloc(gh<_i3.IMustSellRepo>()));
    gh.factory<_i102.NotiReadFlagUpdateBloc>(
        () => _i102.NotiReadFlagUpdateBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i103.NotificationListingBloc>(
        () => _i103.NotificationListingBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i104.NotificationReplayBlocBloc>(
        () => _i104.NotificationReplayBlocBloc(gh<_i3.INotificationRepo>()));
    gh.factory<_i105.OutOfStockItemCustomersBloc>(() =>
        _i105.OutOfStockItemCustomersBloc(gh<_i3.IOutOfStockProductsRepo>()));
    gh.factory<_i106.OutOfStockItemsBloc>(
        () => _i106.OutOfStockItemsBloc(gh<_i3.IOutOfStockProductsRepo>()));
    gh.factory<_i107.OutofstockcountBloc>(
        () => _i107.OutofstockcountBloc(gh<_i3.IMerchandisingDashBoardRepo>()));
    gh.factory<_i108.OutstandingBloc>(
        () => _i108.OutstandingBloc(gh<_i3.IOutStandingHeaderRepo>()));
    gh.factory<_i109.PartialDeliveryApprovalBloc>(() =>
        _i109.PartialDeliveryApprovalBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i110.PartialDeliveryDetailBloc>(
        () => _i110.PartialDeliveryDetailBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i111.PartialDeliveryDetailsBloc>(
        () => _i111.PartialDeliveryDetailsBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i112.PartialDeliveryHeaderBloc>(
        () => _i112.PartialDeliveryHeaderBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i113.PartialDeliveryReasonBloc>(
        () => _i113.PartialDeliveryReasonBloc(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i114.PartialDeliveryReasonCubit>(
        () => _i114.PartialDeliveryReasonCubit(gh<_i3.IPartialDeliveryRepo>()));
    gh.factory<_i115.PickingAndLoadingCountBloc>(() =>
        _i115.PickingAndLoadingCountBloc(gh<_i3.IPickingAndLoadinCountRepo>()));
    gh.factory<_i116.PickingHeaderBloc>(
        () => _i116.PickingHeaderBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i117.PickingdetailBloc>(
        () => _i117.PickingdetailBloc(gh<_i3.IPickingHeaderRepo>()));
    gh.factory<_i118.PostSettlementApprovalBloc>(() =>
        _i118.PostSettlementApprovalBloc(
            gh<_i3.ISettlementApprovalHeaderRepo>()));
    gh.factory<_i119.PriceChangeDetailsBloc>(
        () => _i119.PriceChangeDetailsBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i120.PriceChangeHeaderBloc>(
        () => _i120.PriceChangeHeaderBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i121.PriceChangeReasonsBloc>(
        () => _i121.PriceChangeReasonsBloc(gh<_i3.IPriceChangeRepo>()));
    gh.factory<_i122.PromotionCustomerBloc>(
        () => _i122.PromotionCustomerBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i123.PromotionDetailsBloc>(
        () => _i123.PromotionDetailsBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i124.PromotionHeaderBloc>(
        () => _i124.PromotionHeaderBloc(gh<_i3.IPromotionHeaderRepo>()));
    gh.factory<_i125.QualificationGroupBloc>(
        () => _i125.QualificationGroupBloc(gh<_i3.IQualificationGroupRepo>()));
    gh.factory<_i126.RargetDetailsGraphQtyBloc>(
        () => _i126.RargetDetailsGraphQtyBloc(gh<_i3.ITargetRepo>()));
    gh.factory<_i127.ReturnApprovalDetailBloc>(
        () => _i127.ReturnApprovalDetailBloc(gh<_i3.IReturnApprovalRepo>()));
    ...
    gh.factory<_i130.SalesOrderCountBloc>(
        () => _i130.SalesOrderCountBloc(gh<_i3.ISalesOrderRepo>()));
    gh.factory<_i131.SalesOrderDetailsBloc>(
        () => _i131.SalesOrderDetailsBloc(gh<_i3.ISalesOrdersRepo>()));
    gh.factory<_i132.SchduledReturnApprovalBloc>(() =>
        _i132.SchduledReturnApprovalBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i133.SchduledReturnHeaderBloc>(() =>
        _i133.SchduledReturnHeaderBloc(gh<_i3.IScheduledReturnApprovalRepo>()));
    gh.factory<_i134.ScheduledReturnDetailsBloc>(() =>
        _i134.ScheduledReturnDetailsBloc(
            gh<_i3.IScheduledReturnApprovalRepo>()));
